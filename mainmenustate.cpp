...
namespace SSM
{
    ...
    void MainMenuState::Init()
    {
        ...
        this->_data->assets.LoadSound("Theme Song", MAIN_THEME);
        ...
        this->_sound.setBuffer(this->_data->assets.GetSoundBuffer("Theme Song"));
        ...
        this->_playButton.setPosition( (SCREEN_WIDTH/2 - _playButton.getGlobalBounds().width/2) + _marioBanner.getGlobalBounds().width/4, SCREEN_HEIGHT/2 - _playButton.getGlobalBounds().height/2);
        this->_playButtonOuter.setPosition( (SCREEN_WIDTH/2 - _playButtonOuter.getGlobalBounds().width/2) + _marioBanner.getGlobalBounds().width/4, SCREEN_HEIGHT/2 - _playButtonOuter.getGlobalBounds().height/2);
